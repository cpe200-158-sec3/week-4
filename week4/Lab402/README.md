...
Answer = Yes, any redundant is in Triangle class and Rectangle class.

2. Modify the project so that you can minimize or solve those redundancy.
Answer = Use cuncrete member.

3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
Answer = It have error because Shape class can't create an object when complie.
