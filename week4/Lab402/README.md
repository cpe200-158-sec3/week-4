...
Patraporn Chagsakol 570611028

## Questions:

1. Are there still any redundant lines of code in your project? where?
	Answer : Yes,properties Width and Height in class Triangle and class Pactangle.
...
3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
	Answer : error becourse programs can't created object color.
