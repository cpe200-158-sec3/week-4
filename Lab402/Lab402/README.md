...
Answer : Redundancy is still in Triangle class and Rectangle class.

2. Modify the project so that you can minimize or solve those redundancy.
Answer : Use concrete member.

3. What happen if you uncomment line #27-28 in the Program.cs file? Why?
Answer : It have error when complie because Shape class can't create an object.
